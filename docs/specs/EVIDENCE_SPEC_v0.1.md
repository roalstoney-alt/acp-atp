...
The reference implementation creates deterministic hash-derived event IDs and stores events in a local in-memory ledger.

## Proposed

Future versions should support signatures, transparency logs and selective disclosure proofs.
